# Exemples Officiels p5.js : Couleurs & Styles

Ces exemples montrent comment gérer les couleurs (modèles RGB, HSB, HSL), les contours (`stroke`) et les remplissages (`fill`).

## Exemple : Color Basics
**Source** : p5.js Official Examples
**Description** : Démonstration des différents modes de couleur et des fonctions de style (`background`, `fill`, `stroke`, `noStroke`, `push`, `pop`).
