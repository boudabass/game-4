# Exemples Officiels p5.js : Texte & Typographie

Ces exemples montrent comment charger des polices, manipuler des chaînes de caractères et afficher du texte sur le canvas.

## Exemple : Random Poetry
**Source** : p5.js Official Examples
**Description** : Sélection aléatoire de mots dans un tableau et affichage sur le canvas avec des tailles et positions aléatoires.
