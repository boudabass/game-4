# Exemples Officiels p5.js : Mobile & Capteurs

Ces exemples sont tirés de la documentation officielle et servent de référence pour l'utilisation des fonctionnalités mobiles (Accéléromètre, Tactile).

## Exemple : Mobile Device Movement
**Source** : p5.js Official Examples
**Description** : Utilise l'accéléromètre (`accelerationX`, `accelerationY`, `accelerationZ`) pour contrôler la position et la taille d'un cercle. Ne fonctionne que sur mobile.
...
## Exemple : Shake Ball Bounce
**Source** : p5.js Official Examples
**Description** : Utilisation de classes (`Ball`) et de l'accéléromètre (`accelerationX`, `pAccelerationX`) pour simuler des balles qui rebondissent en réponse au mouvement du téléphone.
