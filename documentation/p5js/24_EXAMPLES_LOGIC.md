# Exemples Officiels p5.js : Logique & Conditions

Ces exemples montrent comment utiliser les structures de contrôle (`if`, `else`) et les opérateurs logiques pour créer des comportements complexes.

## Exemple : Conditions
**Source** : p5.js Official Examples
**Description** : Démonstration de l'utilisation des conditions pour contrôler l'animation. Le cercle ne bouge que si la souris est pressée, change de couleur selon sa position (centre vs bords), et rebondit sur les murs.
