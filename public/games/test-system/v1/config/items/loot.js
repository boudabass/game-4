...
window.Config.ITEM_CATEGORIES.loot = {
    // log: { name: 'Bûches', icon: '🪵' }, // Remplacé par resources.wood
    // coal: { name: 'Charbon', icon: '💎' }, // Remplacé par resources.coal
    ...
    copper_bar: { name: "Lingot de cuivre", icon: "🧱" }, // Was copper_ingot
    iron_bar: { name: "Lingot de fer", icon: "🧱" },
    gold_bar: { name: "Lingot d'or", icon: "🧱" },
    iridium_bar: { name: "Lingot d'iridium", icon: "🧱" },
    refined_quartz: { name: "Quartz raffiné", icon: "💎" },
    battery_pack: { name: "Pile", icon: "🔋" },
    clay: { name: "Argile", icon: "🧱" },
    hardwood: { name: "Bois dur", icon: "🪵" }
};
