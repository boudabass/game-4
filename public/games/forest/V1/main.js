...
function preload() {
  ...
  birdsSound = loadSound('birds.wav');
  karla = loadFont('Karla-Regular.ttf');
  karlaBold = loadFont('Karla-Bold.ttf');
...
function setup() {
  ...
  scene2 = new Scene2();
  scene3 = new Scene3();
  soundOn = createImg("sound-off.png", "Sound on button",
    '',
    () => {
      soundOn.size(50, AUTO);
    });
  soundOff = createImg("sound-on.png", "Sound off button",
    '',
    () => {
