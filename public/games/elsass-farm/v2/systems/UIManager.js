...
window.UIManager = {
    ...
    _closeAllModals: function (exceptId) {
        const modals = ['menu-modal', 'map-modal', 'debug-modal', 'inventory-modal', 'devtools-modal'];
        modals.forEach(id => {
            if (id !== exceptId) {
    ...
    toggleDevTools: function () {
        this._closeAllModals('devtools-modal');
        const el = document.getElementById('devtools-modal');
        if (!el) return;
